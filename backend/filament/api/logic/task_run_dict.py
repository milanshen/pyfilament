...
@beartype
def deep_get_task_run_dict(task_run: TaskRunModel, max_child_tasks: int = 100, child_depth: int = 0) -> dict:
    ...
    if child_depth > 0:
        ...
        task_run_dict['child_tasks'] = [
            deep_get_task_run_dict(child_task_run, max_child_tasks, child_depth - 1)
